                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center text-sm text-text-faded">
                        <svg className="w-4 h-4 mr-2 text-spotify-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-auto flex justify-between items-center pt-4 border-t border-gray-800"> {/* Added border-t */}
